...
//            }
//        }
//        public Set GetSet(string Source_ID)
//        {
//            using (var conn = new SqlConnection(configuration.connectionString))
//            {
//                conn.Open();
//                var sql = $@"select * from [MTG].[Set] where Source_ID = @Source_ID";
//                var result = conn.QuerySingle<Set>(sql, new { Source_ID });
//                return result;
//            }
//        }
...
//            }
//        }
//        public IEnumerable<int> GetPinnedIDs(string UserID)
//        {
//            using (var conn = new SqlConnection(configuration.connectionString))
//            {
//                conn.Open();
//                var sql = "select SetID from [MTG].[PinnedSet] where UserID = @UserID";
//                return conn.Query<int>(sql, new { UserID });
//            }
//        }
//        #endregion
//        #endregion
